...
"""
    This code is being used for an Elegoo DS1307.
    
    Copied from code for a DS3231 from Waveshare.
    https://www.waveshare.com/wiki/Pico-RTC-DS3231
    
    Removed code for alarm.
    
    Can still run this module standalone to get and set 
...
#               sec min hour week day month year
    ...
    def read_time(self):
        ...
        tp.append(self._bcd2dec(t[5]))  # month
        tp.append(self._bcd2dec(t[4]))  # day
        tp.append(self._bcd2dec(t[3]))  # day of week?
        tp.append(self._bcd2dec(t[2]))  # hour
        tp.append(self._bcd2dec(t[1]))  # minute
        tp.append(self._bcd2dec(t[0]))  # seconds
        tp.append(0)  # subseconds
...
if __name__ == '__main__':
    rtc = ds1307(I2C_PORT,I2C_SCL,I2C_SDA)
    # rtc.set_time('10:39:00,Monday,2022-03-14')
    t = rtc.read_time()
    print(t)
